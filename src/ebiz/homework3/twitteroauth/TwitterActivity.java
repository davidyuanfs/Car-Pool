package ebiz.homework3.twitteroauth;
...
import ebiz.homework3.CarPostActivity;
import ebiz.homework3.R;
import ebiz.homework3.ViewRequestsActivity;
...
public class TwitterActivity extends Activity {
	...
	public void onClickBackToPost(View view) {
        ...
        Intent intent = new Intent(TwitterActivity.this, CarPostActivity.class);
    ...
    private View.OnClickListener buttonLogoutOnClickListener = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            Intent intent = new Intent(TwitterActivity.this, TweetActivity.class);
            startActivity(intent);
        }
    };
    ...
    class TwitterUpdateStatusTask extends AsyncTask<String, String, Boolean> {
        ...
        protected void onPostExecute(Boolean result) {
            if (result)
                Toast.makeText(getApplicationContext(), "Tweet successfully", Toast.LENGTH_LONG).show();
            else
                Toast.makeText(getApplicationContext(), "Tweet failed", Toast.LENGTH_LONG).show();
        }
